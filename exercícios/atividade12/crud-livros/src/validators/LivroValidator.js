...
const criarLivroSchema = yup.object({
...
const atualizarLivroSchema = yup.object({
titulo: yup.string(),
autor: yup.string(),
editora: yup.string(),
ano: yup.number().typeError('ano deve ser um número'),
preco: yup.number().typeError('preco deve ser um número').moreThan(-1, 'preco deve ser positivo')
});
